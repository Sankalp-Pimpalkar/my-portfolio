    ...
    return (
        <div className="text-white antialiased">
            <Container title="About">
                <div className="flex border my-8 border-gray-800 bg-gray-900 p-6 justify-start sm:justify-normal gap-5 flex-wrap w-full max-w-3xl h-fit font-normal mx-auto text-gray-300 md:p-10 rounded-md">
